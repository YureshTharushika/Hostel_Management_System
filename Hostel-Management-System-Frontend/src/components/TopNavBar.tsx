...
export default function TopNavBar() {
  return (
    <React.Fragment>
      <div className="fixed w-full flex items-center justify-between h-20 text-white z-10 bg-cyan-500">
        <div className="flex items-center justify-start md:justify-left pl-3 w-14 md:w-64 h-14 border-none">
          <svg
            role="img"
            viewBox="0 0 24 24"
            fill="white"
          ...
          <span className="hidden md:block font-semibold">Hostel Management System</span>
        </div>
